...
export async function MenuModal({ componentParams }: { componentParams: componentParamsType }) {
	...
	return (
		<div className="mt-[--total-header-height] absolute inset-0 w-full peer-checked:flex hidden md:main-padding
			...
			<div className="flex flex-col h-screen w-full bg-gradient-to-br from-primary-bg to-secondary-bg shadow-md 
				...
				<div className="block border-b-2 px-6 py-6 sm:px-12 md:px-6 lg:px-12 md:border-b-0 md:border-r-2 border-secondary-accent">
